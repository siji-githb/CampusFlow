    ...
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4 bg-black/60 animate-fade-in" onClick={onClose}>
      ...
      >
        <div className="px-6 py-4 border-b border-border bg-slate-50/50">
          <h2 className="text-fluid-18 font-bold text-text-main m-0 font-serif">Terms and Conditions</h2>
        </div>
        
        <div className="flex-1 overflow-y-auto p-6 text-fluid-13 text-text-sub leading-relaxed font-sans scrollbar-hide">
          <p className="mb-4">
          ...
          <h3 className="text-fluid-15 font-bold text-text-main mt-6 mb-2">1. Acceptance of Terms</h3>
          <p className="mb-4">
          ...
          <h3 className="text-fluid-15 font-bold text-text-main mt-6 mb-2">2. Description of Service</h3>
          <p className="mb-4">
          ...
          <h3 className="text-fluid-15 font-bold text-text-main mt-6 mb-2">3. Data Privacy Agreement</h3>
          ...
          <h4 className="text-fluid-14 font-bold text-text-main mt-4 mb-2">3.1. Collection of Personal Data</h4>
          ...
          <h4 className="text-fluid-14 font-bold text-text-main mt-4 mb-2">3.2. Purpose and Usage of Data</h4>
          <ul className="list-disc pl-5 mb-4 space-y-1">
          ...
          <h4 className="text-fluid-14 font-bold text-text-main mt-4 mb-2">3.3. AI Processing & Third-Party Disclosure</h4>
          ...
          <h4 className="text-fluid-14 font-bold text-text-main mt-4 mb-2">3.4. Data Retention and Security</h4>
          <p className="mb-4">
          ...
          <h3 className="text-fluid-15 font-bold text-text-main mt-6 mb-2">4. User Responsibilities</h3>
          ...
          <h3 className="text-fluid-15 font-bold text-text-main mt-6 mb-2">5. Limitation of Liability</h3>
          <p className="mb-4">
          ...
          <h3 className="text-fluid-15 font-bold text-text-main mt-6 mb-2">6. Changes to Terms</h3>
          <p className="mb-6">
          ...
          <p className="italic text-text-muted text-fluid-12 border-t border-border pt-4">
        ...
        <div className="p-4 border-t border-border bg-slate-50/50 flex justify-end">
          <button 
            onClick={onClose}
            className="px-6 py-2 rounded-lg bg-maroon text-white font-bold text-fluid-13 border-none cursor-pointer hover:bg-maroon-dark transition-colors shadow-sm"
          >
            Close
          </button>
        </div>
