          ...
          <div style={{ background: M.white, padding: '24px', borderRadius: '16px', boxShadow: '0 4px 12px rgba(0,0,0,0.05)', border: `1px solid ${M.border}` }}>
            ...
            <form onSubmit={handleManualAdd} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
              <div style={{ gridColumn: '1 / -1' }}>
                <input type="text" placeholder="Student ID (e.g., 2026-00001)" pattern="^\d{4}-\d{4,5}$" title="Format: 0000-0000 or 0000-00000" required value={form.student_id} onChange={e => setForm({...form, student_id: e.target.value})} style={inp} onFocus={e => e.target.style.borderColor=M.maroon} onBlur={e => e.target.style.borderColor=M.border} />
              </div>
              <div>
