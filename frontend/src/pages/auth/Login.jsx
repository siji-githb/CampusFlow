          ...
          <div className="w-full max-w-85 sm:max-w-95 mx-auto">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-3.5 sm:mb-5">
                <label className="block text-[11.5px] sm:text-[12.5px] font-bold text-slate-700 mb-1.5 sm:mb-2">Email Address</label>
                <div className="relative flex items-center">
                  ...
                  <input 
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-slate-50/50 text-slate-800 outline-none box-border font-sans transition-all duration-200 focus:bg-white focus:border-maroon focus:ring-[3px] focus:ring-maroon/10 py-2.5 sm:py-3 pl-10 pr-3.5 text-[13.5px] sm:text-sm shadow-sm placeholder:text-slate-400 font-medium" 
                  />
                </div>
              </div>
              
              <div className="mb-5 sm:mb-7">
                <label className="block text-[11.5px] sm:text-[12.5px] font-bold text-slate-700 mb-1.5 sm:mb-2">Password</label>
                <div className="relative flex items-center">
                  ...
                  <input 
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-slate-50/50 text-slate-800 outline-none box-border font-sans transition-all duration-200 focus:bg-white focus:border-maroon focus:ring-[3px] focus:ring-maroon/10 py-2.5 sm:py-3 pl-10 pr-11 text-[13.5px] sm:text-sm shadow-sm placeholder:text-slate-400 font-medium" 
                  />
                ...
                <div className="flex justify-between items-center mt-3 sm:mt-4">
                  <label className="flex items-center gap-1.5 sm:gap-2 cursor-pointer group">
                    <input type="checkbox" checked={rememberMe} onChange={e => setRememberMe(e.target.checked)} className="accent-maroon w-3.5 h-3.5 sm:w-4 sm:h-4 cursor-pointer m-0 rounded-sm border-slate-300" />
                    <span className="text-[12px] sm:text-[13px] text-slate-600 font-medium group-hover:text-slate-800 transition-colors">Remember me</span>
                  </label>
                  <Link to="/forgot-password" className="text-[12px] sm:text-[13px] text-maroon no-underline font-bold hover:text-maroon-dark transition-colors">Forgot password?</Link>
                </div>
              </div>

              <button type="submit" disabled={loading} className={`w-full py-2.5 sm:py-3.5 px-5 sm:px-6 rounded-xl border-none text-[13.5px] sm:text-[14.5px] font-bold font-sans shadow-[0_4px_12px_rgba(123,26,42,0.15)] transition-all duration-200 flex items-center justify-center gap-2 ${loading ? 'bg-maroon/70 text-white cursor-not-allowed' : 'bg-maroon text-white cursor-pointer hover:bg-maroon-dark hover:shadow-[0_6px_16px_rgba(123,26,42,0.25)] hover:-translate-y-px'}`}>
